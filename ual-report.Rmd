...
+ UAL offered an above-average number of these data services; the number of 
services directly supported by UAL is higher than expected given total 
...
ubiquitous, found at all surveyed libraries. At the rare end, support for 
electronic laboratory notebooks and web scraping were found in fewer than 25% 
of libraries we surveyed. Libraries provided support for an average of 11 of 
...
offered the fewest surveyed data services (4) and had the second-lowest 
