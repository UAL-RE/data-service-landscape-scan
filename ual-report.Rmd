...
described using a Qualtrics form. For a subset of the services, we also 
...
2019 were considered present at an intitution's library.
...
[GitHub](https://github.com/UAL-RE/data-service-landscape-scan).
...
(12)](output/service-dist-ranks-az.png){ padding=40px }
...
important developmental work in geospatial services.
